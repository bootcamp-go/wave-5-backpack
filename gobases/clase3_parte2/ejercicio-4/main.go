...
func InsertionSort(arr []int, c chan Resultado) {
	...
	c <- Resultado{"Ordenamiento por inserción", time.Since(tiempo).Nanoseconds()}
}
...
func BubbleSort(arr []int, c chan Resultado) {
	...
	c <- Resultado{"Ordenamiento por burbuja", time.Since(tiempo).Nanoseconds()}
}
...
func main() {
	...
	fmt.Println("Resultados para arreglo de 100 elementos:")
	...
	fmt.Println("Resultados para arreglo de 1000 elementos:")
	fmt.Println("Posición\t Nombre\t\t\t\t Tiempo")
	for i := 0; i < 3; i++ {
		resultadoTmp = <-c
		fmt.Println(i+1, "\t\t", resultadoTmp.nombre, "\t", resultadoTmp.tiempo, "ns")
	...
	fmt.Println("Resultados para arreglo de 10000 elementos:")
	fmt.Println("Posición\t Nombre\t\t\t\t Tiempo")
	for i := 0; i < 3; i++ {
		resultadoTmp = <-c
		fmt.Println(i+1, "\t\t", resultadoTmp.nombre, "\t", resultadoTmp.tiempo, "ns")
