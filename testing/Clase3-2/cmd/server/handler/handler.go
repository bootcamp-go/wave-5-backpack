...
func (u *Usuario) Store() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		user, err := u.service.Store(req.Nombre, req.Apellido, req.Email, req.Edad, req.Altura, req.Activo, req.FechaDeCreacion)
		if err != nil {
			ctx.JSON(400, web.NewResponse(400, nil, err.Error()))
			return
		}
...
func (user *Usuario) Update() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		u, err := user.service.Update(int(id), req.Nombre, req.Apellido, req.Email, req.Edad, req.Altura, req.Activo, req.FechaDeCreacion)
		if err != nil {
