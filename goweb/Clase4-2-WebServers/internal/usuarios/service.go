...
import "goweb/Clase4-2-WebServers/internal/domain"

type Service interface {
	GetAll() ([]domain.Usuario, error)
	Store(nombre, apellido, email string, edad, altura int, activo bool) (domain.Usuario, error)
...
func (s *service) Store(nombre, apellido, email string, edad, altura int, activo bool) (domain.Usuario, error) {
...
func (s *service) Update(id int, nombre, apellido, email string, edad, altura int, activo bool) (domain.Usuario, error) {
