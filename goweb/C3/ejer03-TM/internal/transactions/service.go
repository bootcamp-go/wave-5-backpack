...
import "ejer02-TT/internal/domain"
...
func (s *service) UpdateCodeAndAmount(id int, tranCode string, amount float64) (domain.Transaction, error) {
	return s.repository.UpdateCodeAndAmount(id, tranCode, amount)
}
