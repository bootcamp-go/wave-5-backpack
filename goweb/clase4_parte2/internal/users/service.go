...
func (s *service) Store(nombre, apellido, email string, edad int, altura float64, activo *bool) (domain.User, error) {
...
func (s *service) Update(id int, nombre, apellido, email string, edad int, altura float64, activo *bool) (domain.User, error) {
	u, err := s.repository.Update(id, nombre, apellido, email, edad, altura, activo)
	if err != nil {
