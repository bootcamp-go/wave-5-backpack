...
// func validarRequest(r request) error {
// 	var requerido, valido []string

// 	if r.Nombre != "" {
// 		requerido = append(requerido, S_NAME)
// 	}
// 	if r.Color != "" {
// 		requerido = append(requerido, S_COLOR)
// 	}
// 	if r.Precio < 0 {
// 		valido = append(valido, S_PRICE)
// 	} else {
// 		price = Tem
// 	}

// 	if r.Stock < 0 {
// 		Tem, err := strconv.Atoi()
// 		if err != nil {
// 			errorValidacion = append(errorValidacion, S_STOCK)
// 		} else {
// 			stock = Tem
...
// if len(errStruct) > 0 {
// 	if len(errStruct) > 1 {
// 		return fmt.Errorf("Los campos %s son requeridos.", strings.Join(errStruct, ", "))
// 	} else {
// 		return fmt.Errorf("El campo %s es requerido.", errStruct[0])
// 	}
// }
// 	return nil
// }
