...
const (
	Store                  = "INSERT INTO products(name, type, price, count, code, public) VALUES (?,?,?,?,?,?)"
	GetProductByName       = "SELECT id, name, type, price, count, code, public FROM products WHERE name = ?"
