...
func main() {
	...
	ser := tickets.NewService(rep)
	han := handler.NewService(ser)
	...
	{
		rTicket.GET("/getByCountry/:dest", han.GetTicketsByCountry())
		rTicket.GET("/getAverage/:dest", han.AverageDestination())
	}
