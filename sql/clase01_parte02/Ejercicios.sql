...
SELECT title FROM movies WHERE release_date BETWEEN '2004-01-01 00:00:00' AND '2009-01-01 00:00:00';
...
SELECT title FROM movies WHERE rating > 3 AND awards > 1 AND release_date BETWEEN '1988-01-01 00:00:00' AND '2009-01-01 00:00:00' ORDER BY rating LIMIT 3 OFFSET 10;