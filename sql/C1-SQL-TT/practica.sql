-- 2. Mostrar todos los registros de la tabla movies
-- SELECT * FROM movies;
...
-- 14. Mostrar el titulo y rating de todas las películas cuyo título sea de Toy Story
...
-- SELECT title AS titulo FROM movies WHERE rating > 3 AND awards > 1 AND release_date BETWEEN '1988-01-01' AND '2009-12-31' ORDER BY rating LIMIT 3;
