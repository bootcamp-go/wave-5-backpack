...
SELECT title titulo FROM movies_db.series series;
-- 5 Mostrar el nombre y apellido de los actores cuyo rating sea mayor a 7.5.
SELECT * FROM movies_db.actors WHERE rating>7.5;
...
SELECT title FROM movies WHERE rating>3 AND awards>1 AND release_date BETWEEN '19880101' AND '20091231' order by rating LIMIT 3 OFFSET 10;
